                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control" 
                                   value="{{ $customerGroup->name }}" required autofocus>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" class="form-control" rows="4" 
                                      placeholder="Enter group description (optional)">{{ $customerGroup->description }}</textarea>
                        </div>

                        <div class="form-group">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input" id="is_active" 
                                       name="is_active" {{ $customerGroup->is_active ? 'checked' : '' }}>
                        ...
                        <div class="alert alert-info">
                            ...
                            This group has <strong>{{ $customerGroup->customers()->count() }}</strong> customer(s) assigned.
                        </div>
                        @endif
                    </div>
    ...
    <script>
        $(document).ready(function() {
            $('#groupForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: '{{ route("customer-groups.update", $customerGroup->id) }}',
                    method: 'PUT',
                    data: formData,
